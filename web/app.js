...
function renderDiagnosis(d) {
  ...
  if (d.done) {
    ...
    p.innerHTML = `${head}${hist}${maint}<div class="outcome ${d.outcome}">${L.outcome[d.outcome]}</div>` +
      ...
      (parts ? `<ul class="nparts">${parts}</ul>` : "") +
